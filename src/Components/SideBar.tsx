        ...
        {isOpen && (
          <>
            <div className="w-full h-[128px] bg-[#363636] grid place-items-center relative">
              ...
              <div className="h-[42px] w-[42px] rounded-full bg-black absolute bottom-[-21px] right-[-21px] grid place-items-center">
                <img src={Left} alt="Left" onClick={() => closeSidebar()} />
              </div>
            </div>

            <div className="flex-1 pt-[48px] pl-6">
              <div className="h-[44px] flex items-center gap-3 cursor-pointer hover:bg-gray-100 px-4 rounded-l-lg">
                <svg
